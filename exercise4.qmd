...
ggplot(octopus_10, aes(time_difference))+ 
  geom_histogram(binwidth = 10)
  geom_vline(xintercept = mean(octopus_10$time_difference, na.rm=T)) 
...
I simply plot my fixes as I only have moving trajectories from strava. Otherwise, I woult filter via the attribute static = TRUE and colour the plot (static/movement).
